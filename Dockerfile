...
ARG APT_PACKAGES="autoconf build-essential cmake curl git gforth iputils-ping make net-tools openssh-client python3-dev sudo telnet tree tzdata unzip neovim zip"
