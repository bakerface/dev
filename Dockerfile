...
ARG APT_PACKAGES="autoconf build-essential clangd cmake curl git gforth htop iputils-ping make net-tools openssh-client python3-dev sudo telnet tree tzdata unzip neovim zip"
